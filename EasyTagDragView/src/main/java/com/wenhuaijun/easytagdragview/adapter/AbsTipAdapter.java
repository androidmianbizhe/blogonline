...
public abstract class AbsTipAdapter extends BaseAdapter implements
     ...
     */
    protected ArrayList<SimpleTitleTip> tips = null;
    /**
     * Back up of（备份） the temporarily removed Contact during dragging.
     */
    private SimpleTitleTip tempTip = null;
    /**
    ...
    public static SimpleTitleTip BLANK_ENTRY = new SimpleTitleTip() {
        private int id;
    ...
    public interface DragDropListener {
        ...
        void onDataSetChangedForResult(ArrayList<SimpleTitleTip> list);
    }
    ...
    public AbsTipAdapter(Context context,
        ...
        mContext = context;
        tips = new ArrayList<SimpleTitleTip>();
    ...
    //当数据改变时调用
    public void setData(List<SimpleTitleTip> tips) {
     ...
     */
    @Override
    public SimpleTitleTip getItem(int position) {
     ...
     * @return
     */
    protected abstract SimpleTitleTip getDragEntity(View view);
