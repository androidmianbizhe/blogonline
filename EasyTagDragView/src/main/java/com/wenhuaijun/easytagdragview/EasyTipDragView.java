...
public class EasyTipDragView extends RelativeLayout implements AbsTipAdapter.DragDropListener, TipItemView.OnDeleteClickListener,View.OnClickListener{
    ...
    private ArrayList<SimpleTitleTip> lists;
    ...
    @Override
    public void onDataSetChangedForResult(ArrayList<SimpleTitleTip> lists) {
        this.lists =lists;
    ...
    @Override
    public void onDeleteClick(SimpleTitleTip entity, int position, View view) {
        addTipAdapter.getData().add(entity);
        addTipAdapter.refreshData();
        dragTipAdapter.getData().remove(position);
        dragTipAdapter.refreshData();
    }
    public void setDragData(List<SimpleTitleTip> tips){
        dragTipAdapter.setData(tips);
    }
    public void setAddData(List<SimpleTitleTip> tips){
    ...
    public interface OnDataChangeResultCallback{
        void onDataChangeResult(ArrayList<SimpleTitleTip> tips);
    }
    //在最后点击"完成"关闭EasyTipDragView时回调
    public interface OnCompleteCallback{
        void onComplete(ArrayList<SimpleTitleTip> tips);
        void onCancel();
    }
